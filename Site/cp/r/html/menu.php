<nav class="top-bar" data-topbar>
  <ul class="title-area">
    ...
    <li class="toggle-topbar menu-icon"><a href="#"><span><?=$inline["menu"]?></span></a></li>
  </ul>
  ...
  <section class="top-bar-section">
    ...
    <ul class="left">
      <li class="has-dropdown">
        <a href="#" id="joy_menu_ver"><?=$inline["listar"]?></a><ul class="dropdown">
          <?
      ...
      <li class="has-dropdown">
        <a href="#" id="joy_menu_cargar"><?=$inline["cargar"]?></a><ul class="dropdown">
          <?
		  foreach($secciones as $key => $val){
      ...
      <li class="has-dropdown">
        <a href="#"><?=$inline["pages"]?></a>
        <ul class="dropdown">
         	<li><a href='./?q=aboutus'>About us</a></li>
    ...
    <ul class="right">
      ...
      ?>
      <li class="alert"><a href="#" onclick="$(document).foundation('joyride', 'start');"><?=$str["joytext"]?></a></li>
      <li class="alert"><a href="./logout.php" id="joy_menu_salir"><?=$inline["salir"]?></a></li>
    </ul>
  </section>
</nav>